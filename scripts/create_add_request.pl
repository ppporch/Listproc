...
<script>
    ...
    <link rel="stylesheet" href="//a.fsdn.com/con/css/lato.css?1777491863">
        ...
        <meta name="description" content="Download ListProc Open Source create_add_request.pl. ">
<meta name="keywords" content="Download ListProc Open Source create_add_request.pl. ">

<noscript>
    <meta http-equiv="refresh" content="5; url=https://downloads.sourceforge.net/project/listproc/scripts/scripts-092203/create_add_request.pl?ts=gAAAAABp9VL0TspJret1194y9HSFVK3aZGD0O_PH6BvMmtqGsHapOPhsJmhe88CnD5iXaCXFjtOnF4nYeVtXSQ2c55PkyJLf_Q%3D%3D&amp;use_mirror=master&amp;r=">
</noscript>

        <title>Download create_add_request.pl (ListProc Open Source)</title>
...
<link rel="mask-icon" href="//a.fsdn.com/con/img/sandiego/svg/originals/sf-icon-orange-no_sf.svg" color="#FF6600">
        ...
        <script>
            ...
            if (!window.SF) {
                window.SF = {};
            }SF.EU_country_codes = ["NL","MF","PF","NO","RE","GP","FI","LV","RO","MT","ME","ES","BG","IS","DK","TC","PN","EE","HU","GI","CZ","FK","BE","BL","CW","CH","GB","MQ","IO","SH","GR","SE","AW","WF","GS","AT","PT","SX","FR","NC","BM","LI","JE","AI","IE","GF","LT","HR","VG","KY","PM","SK","IT","MS","PL","CY","TF","DE","YT","GG","LU","SI","GL","AX"];
        ...
        <style>.ff1d6e4aa85a38a078b10ac693228616d4f97c9a5 { display: none !important; }</style>
...
<div class="social-sharing-buttons invisible hide">
    ...
    <a rel=nofollow class="social-media-icon twitter" href="https://x.com/share?url=https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/create_add_request.pl/download&amp;text=Download%20ListProc%20Open%20Source%20on%20SourceForge%20for%20free%21%20" title="Share ListProc Open Source on SourceForge on X">
...
<svg  data-name="x-logo" viewBox="0 0 1200 1227" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" fill="white"/></svg></a>
    <a rel=nofollow class="social-media-icon facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/create_add_request.pl/download&title=ListProc%20Open%20Source%20on%20SourceForge" title="Share ListProc Open Source on SourceForge on facebook">
...
<svg  data-name="facebook" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1343 12v264h-157q-86 0-116 36t-30 108v189h293l-39 296h-254v759h-306v-759h-255v-296h255v-218q0-186 104-288.5t277-102.5q147 0 228 12z"/></svg></a>
    <a rel=nofollow class="social-media-icon linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url=https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/create_add_request.pl/download&title=ListProc%20Open%20Source%20on%20SourceForge&source=SourceForge.net" title="Share ListProc Open Source on SourceForge on LinkedIn">
...
<svg  data-name="linkedin" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M477 625v991h-330v-991h330zm21-306q1 73-50.5 122t-135.5 49h-2q-82 0-132-49t-50-122q0-74 51.5-122.5t134.5-48.5 133 48.5 51 122.5zm1166 729v568h-329v-530q0-105-40.5-164.5t-126.5-59.5q-63 0-105.5 34.5t-63.5 85.5q-11 30-11 81v553h-329q2-399 2-647t-1-296l-1-48h329v144h-2q20-32 41-56t56.5-52 87-43.5 114.5-15.5q171 0 275 113.5t104 332.5z"/></svg></a>
    ...
    <a class="button default mirror" id="btn-problems-downloading" data-release-url="https://downloads.sourceforge.net/project/listproc/scripts/scripts-092203/create_add_request.pl?ts=gAAAAABp9VL0TspJret1194y9HSFVK3aZGD0O_PH6BvMmtqGsHapOPhsJmhe88CnD5iXaCXFjtOnF4nYeVtXSQ2c55PkyJLf_Q%3D%3D&amp;use_mirror=master&amp;r=" rel="nofollow" href="/settings/mirror_choices?projectname=listproc&amp;filename=scripts/scripts-092203/create_add_request.pl&amp;selected=master">Problems Downloading?</a>
...
<select id="employees-9886082" name="employees"  class="employees use-placeholder-color" >
...
<span></span>
    ...
    <script>
        ...
        function loadimg(params, dimension_prefix) {
            params = Object.assign({"idsite":1,"rec":1,"rand":3789,"dimension2":"pg_dwnld","url":"https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/create_add_request.pl/download","action_name":"Download create_add_request.pl (ListProc Open Source)"}, params);
...
<script type="text/javascript">
    bizx.cmp.ifConsent({ purposes: ['storage', 'measurement'], vendors: 'google-analytics'}, function () {
        ...
        gtag('js', new Date());
        gtag('set', {
            'page_location': 'https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/create_add_request.pl/download',
        });
    });
</script>
    <script>
    ...
    $(function() {
        bizx.cmp.ifConsent({ purposes: 'all' , vendors: 'narrative'}, function() {
            ...
            let imageUrl = "https://io.narrative.io/?companyId=2440&id=first_party%3A0a2bf8b6-cbdf-461b-b278-ab357924498f&id=site_name%3Asourceforge.net&id=url%3A%2Fprojects%2Flistproc%2Ffiles%2Fscripts%2Fscripts-092203%2Fcreate_add_request.pl%2Fdownload&id=pagetitle%3ADownload+create_add_request.pl+%28ListProc+Open+Source%29&id=vertical%3AOpen+Source+Software&id=product%3AListProc+Open+Source&id=topics%3AMailing+List+Servers&id=action%3ADownloaded+ListProc+Open+Source&id=action%3ADownloaded+Mailing+List+Servers+Software";
...
<script>
        ...
        <span id="0c58d640-1424-491e-99da-752055bd7065"></span>
        <script>
            bizx.cmp.trackingPixel('', ['storage', 'measurement', 'ads'], 'https://passport.bizx.info/opi/v1/contacts/put-fpe/dbb1d8999b1b50639defedfb75d98a10?action=https%3A//sourceforge.net/projects/listproc/files/scripts/scripts-092203/create_add_request.pl/download&amp;source=webpage&amp;topics=Mailing%20List%20Servers', '', '0c58d640-1424-491e-99da-752055bd7065', true);
        </script>
