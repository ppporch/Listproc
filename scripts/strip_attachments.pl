...
<script>
    ...
    <link rel="stylesheet" href="//a.fsdn.com/con/css/lato.css?1777491863">
        ...
        <meta name="description" content="Download ListProc Open Source strip_attachments.pl. ">
<meta name="keywords" content="Download ListProc Open Source strip_attachments.pl. ">

<noscript>
    <meta http-equiv="refresh" content="5; url=https://downloads.sourceforge.net/project/listproc/scripts/scripts-092203/strip_attachments.pl?ts=gAAAAABp9VHQsbkKsFK3cMqVOZUnODkCTXGQchLvb1lW0hF2zihQ8GNopFRXixwOz-89evaS0jFqEYTtsM5Xy5YlaFwDvFvnvA%3D%3D&amp;use_mirror=master&amp;r=">
</noscript>

        <title>Download strip_attachments.pl (ListProc Open Source)</title>
...
<link rel="mask-icon" href="//a.fsdn.com/con/img/sandiego/svg/originals/sf-icon-orange-no_sf.svg" color="#FF6600">
        ...
        <script>
            ...
            if (!window.SF) {
                window.SF = {};
            }SF.EU_country_codes = ["GB","CW","KY","CH","IE","AI","MT","GR","WF","VG","SE","SX","RO","LI","DK","PN","ES","FK","FI","FR","IS","CY","EE","NO","PL","GS","BL","BM","TF","SI","IT","MS","TC","LV","AX","GF","CZ","DE","AW","PF","ME","SK","MQ","HR","NL","IO","BE","JE","SH","LU","GL","GP","GI","BG","NC","RE","HU","YT","PT","GG","PM","LT","MF","AT"];
        ...
        <style>.Ub1fe6610d3e68638aa3b6b08ce63a49d9cace02e { display: none !important; }</style>
...
<svg  data-name="linkedin" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M477 625v991h-330v-991h330zm21-306q1 73-50.5 122t-135.5 49h-2q-82 0-132-49t-50-122q0-74 51.5-122.5t134.5-48.5 133 48.5 51 122.5zm1166 729v568h-329v-530q0-105-40.5-164.5t-126.5-59.5q-63 0-105.5 34.5t-63.5 85.5q-11 30-11 81v553h-329q2-399 2-647t-1-296l-1-48h329v144h-2q20-32 41-56t56.5-52 87-43.5 114.5-15.5q171 0 275 113.5t104 332.5z"/></svg></a>
    ...
    <a class="button default mirror" id="btn-problems-downloading" data-release-url="https://downloads.sourceforge.net/project/listproc/scripts/scripts-092203/strip_attachments.pl?ts=gAAAAABp9VHQsbkKsFK3cMqVOZUnODkCTXGQchLvb1lW0hF2zihQ8GNopFRXixwOz-89evaS0jFqEYTtsM5Xy5YlaFwDvFvnvA%3D%3D&amp;use_mirror=master&amp;r=" rel="nofollow" href="/settings/mirror_choices?projectname=listproc&amp;filename=scripts/scripts-092203/strip_attachments.pl&amp;selected=master">Problems Downloading?</a>
...
<select id="employees-3521161" name="employees"  class="employees use-placeholder-color" >
...
<span></span>
    ...
    <script>
        ...
        function loadimg(params, dimension_prefix) {
            params = Object.assign({"idsite":1,"rec":1,"rand":43386,"dimension2":"pg_dwnld","url":"https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/strip_attachments.pl/download","action_name":"Download strip_attachments.pl (ListProc Open Source)"}, params);
...
<script type="text/javascript">
    bizx.cmp.ifConsent({ purposes: ['storage', 'measurement'], vendors: 'google-analytics'}, function () {
        ...
        gtag('js', new Date());
        gtag('set', {
            'page_location': 'https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/strip_attachments.pl/download',
        });
    });
</script>
    <script>
    ...
    $(function() {
        bizx.cmp.ifConsent({ purposes: 'all' , vendors: 'narrative'}, function() {
            ...
            let imageUrl = "https://io.narrative.io/?companyId=2440&id=first_party%3A0a2bf8b6-cbdf-461b-b278-ab357924498f&id=site_name%3Asourceforge.net&id=url%3A%2Fprojects%2Flistproc%2Ffiles%2Fscripts%2Fscripts-092203%2Fstrip_attachments.pl%2Fdownload&id=pagetitle%3ADownload+strip_attachments.pl+%28ListProc+Open+Source%29&id=vertical%3AOpen+Source+Software&id=product%3AListProc+Open+Source&id=topics%3AMailing+List+Servers&id=action%3ADownloaded+ListProc+Open+Source&id=action%3ADownloaded+Mailing+List+Servers+Software";
