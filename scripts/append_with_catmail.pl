<!doctype html><html class="no-js" lang="en">
    ...
    <link rel="stylesheet" href="//a.fsdn.com/con/css/sftheme/sandiego/cmp.css?1777491863">
    
    <script>
        window.bizx.cmp.init({
            
                logged_in_user_record_api: '/p/sfapi/record_user_opt_out',
                logged_in_user_record_api_in: '/p/sfapi/record_user_opt_in',
            geo: {
                is_euro_union: 0,
                country_code2: 'US',
                region: 'TN',
        ...
        <script>
            ...
            SF.variant = 'sf';
            SF.fpid = '0a2bf8b6-cbdf-461b-b278-ab357924498f';
...
<script>
    var data = {hem: "4df45e0518fd7a0dcc6af6517acb5dc08acaf9abeae997897fed94bef37a6125" };
    ...
    <link rel="stylesheet" href="//a.fsdn.com/con/css/lato.css?1777491863">
        ...
        <meta name="description" content="Download ListProc Open Source append_with_catmail.pl. ">
<meta name="keywords" content="Download ListProc Open Source append_with_catmail.pl. ">

<noscript>
    <meta http-equiv="refresh" content="5; url=https://downloads.sourceforge.net/project/listproc/scripts/scripts-092203/append_with_catmail.pl?ts=gAAAAABp9VM8F9UNONiumWRRytj8795cuEpn4wdtYRK6nqQJfCJ0lwTjGTM7fpOvcW5XW68V1kLE-EFnilnORiUE5y4KDggXaQ%3D%3D&amp;use_mirror=master&amp;r=">
</noscript>

        <title>Download append_with_catmail.pl (ListProc Open Source)</title>
...
<link rel="mask-icon" href="//a.fsdn.com/con/img/sandiego/svg/originals/sf-icon-orange-no_sf.svg" color="#FF6600">
        ...
        <link rel="canonical" href="https://sourceforge.net/projects/listproc/">
        ...
        <script>
            ...
            if (!window.SF) {
                window.SF = {};
            }SF.EU_country_codes = ["SK","YT","GS","BG","VG","GR","NL","LT","ME","WF","AX","NC","LU","DE","MF","PM","PL","SH","FR","HR","BL","FI","SX","GB","JE","GG","GL","GF","NO","IO","AI","GP","AT","RE","BM","ES","LI","IE","CZ","MT","PN","CW","KY","TC","HU","CY","EE","BE","AW","IS","MS","SE","PF","GI","TF","LV","IT","MQ","SI","PT","RO","FK","CH","DK"];
        ...
        <style>.I3ccc1e8e705de25a5690a4d483368c5a0d6dab4d { display: none !important; }</style>
    <link rel="alternate" type="application/rss+xml" title="ListProc Open Source&#8230;Recent Activity" href="/p/listproc/activity/feed" />
...
<script>
    ...
    <body id="pg_dwnld"
          class="  authenticated  sandiego v-sf">
...
<svg  data-name="search" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1216 832q0-185-131.5-316.5t-316.5-131.5-316.5 131.5-131.5 316.5 131.5 316.5 316.5 131.5 316.5-131.5 131.5-316.5zm512 832q0 52-38 90t-90 38q-54 0-90-38l-343-342q-179 124-399 124-143 0-273.5-55.5t-225-150-150-225-55.5-273.5 55.5-273.5 150-225 225-150 273.5-55.5 273.5 55.5 225 150 150 225 55.5 273.5q0 220-124 399l343 343q37 37 37 90z"/></svg>
        ...
        <li class="highlight"><a href="/auth/preferences/">Account Settings</a>
        <li class="highlight"><a href="/auth/logout">Log Out</a></li>
...
<svg  data-name="mmSF_11mail" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 42 42" enable-background="new 0 0 42 42" xml:space="preserve"><path fill="#FFFFFF" d="M0,6v30h42V6H0z M24.2,21.2c-0.8,0.8-2.3,2-3.2,2c-0.9,0-2.4-1.2-3.2-2L5.8,9.7h30.3L24.2,21.2z M13.7,21l-9.9,9.4V11.6L13.7,21z M15.7,23L15.7,23c0.5,0.5,2.9,2.9,5.3,2.9c2.4,0,4.8-2.4,5.2-2.8l0.1-0.1l9.8,9.4H5.8L15.7,23z M28.3,21l9.9-9.5v18.9L28.3,21z"/></svg></span></a>
                ...
                <nav id="nav-account">
                    <ul id="account-tooltip" class="tooltip-container">
                        <li>
                            <a href="/u/ppporch/profile">
                                Me &#x25BE;
                            </a>
                            <ul id="account-menu" class="menu account">
                                <li>
                                    <a href="/u/ppporch/profile">Profile</a>
                                </li>
                                <li>
                                    <a href="/auth/preferences/"><b class="fa fa-user" title="Account"></b>
                                        Account Settings</a>
                                </li>
                                <li>
                                    <a href="/auth/logout"><b class="fa fa-power-off" title="Log Out"></b>
                                        Log Out</a>
                                </li>
                            </ul>
                        </li>
                        <li id="updater-tooltip-sd" class="tooltip-container">
                            

<a href="/user/updates" title="Manage Update Notifications" class="updates available">1</a>
<ul id="account-tooltip-menu" class="updater menu">
    <li class="title">Available Updates</li>
    <li class="description">The following software titles have updates:</li>
    
    <li class="project-list-item">
        
        <a href="/projects/listproc/">


<svg  data-name="default-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><rect class="st0" width="300" height="300"/><g><path class="st1" d="M162.5,154.8c0-28.9-10.2-42-15.6-46.9c-1.1-1-2.7-0.1-2.6,1.3c1.1,16.3-19.4,20.3-19.4,45.9h0c0,0.1,0,0.1,0,0.2c0,15.6,11.8,28.3,26.3,28.3c14.5,0,26.3-12.7,26.3-28.3c0-0.1,0-0.1,0-0.2h0c0-7.2-2.7-14.1-5.5-19.3c-0.5-1-2.1-0.6-1.9,0.3C174.9,158.1,162.5,171.8,162.5,154.8z"/><g><path class="st1" d="M131.2,215.6c-0.7,0-1.3-0.3-1.8-0.7l-67.2-67.1c-1-1-1-2.6,0-3.6l70.9-70.9c0.5-0.5,1.1-0.7,1.8-0.7h20.4c1.2,0,2,0.8,2.3,1.6c0.3,0.7,0.3,1.9-0.5,2.7l-66.7,66.7c-1.3,1.3-1.3,3.5,0,4.9l52.7,52.7c1,1,1,2.6,0,3.6L133,214.9C132.5,215.4,131.9,215.6,131.2,215.6z"/></g><g><path class="st1" d="M144.7,227.4c-1.2,0-2-0.8-2.3-1.5c-0.3-0.7-0.3-1.9,0.5-2.7l66.7-66.7c0.7-0.6,1-1.5,1-2.4s-0.4-1.8-1-2.4l-52.7-52.7c-1-1-1-2.6,0-3.6l10.2-10.2c0.5-0.5,1.1-0.7,1.8-0.7c0.7,0,1.3,0.3,1.8,0.7l67,67.1c0.5,0.5,0.7,1.1,0.7,1.8s-0.3,1.3-0.7,1.8l-70.9,70.9c-0.5,0.5-1.1,0.7-1.8,0.7H144.7z"/></g></g></svg></a>
        <a title="ListProc Open Source" href="/projects/listproc/">ListProc Open Source</a>
        <a href="/projects/listproc/files/latest/download/" class="download-icon">


<svg  data-name="download-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><rect x="0" y="230.4" class="st0" width="300" height="69.6"/><polygon class="st0" points="189.4,103.2 189.4,0 110.6,0 110.6,103.2 57.9,103.2 150,214.1 242.1,103.2 "/></svg></a>
    </li>
    
    <li><a href="/user/updates">Manage Subscriptions</a></li>
</ul>
    ...
    <nav id="breadcrumbs" class="breadcrumbs rtl">
        <ul itemscope itemtype="http://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                ...
                <a itemprop="item" href="/directory/communications/">
                ...
                <a itemprop="item" href="/directory/email/">
                ...
                <a itemprop="item" href="/directory/mailing-list-servers/">
                    <span itemprop="name">Mailing List Servers</span>
                </a>
                
                <meta itemprop="position" content="5" />
            </li><li class="project" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemprop="name">ListProc Open Source</span><meta itemprop="position" content="6" />
            </li>
...
<svg  data-name="default-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><rect class="st0" width="300" height="300"/><g><path class="st1" d="M162.5,154.8c0-28.9-10.2-42-15.6-46.9c-1.1-1-2.7-0.1-2.6,1.3c1.1,16.3-19.4,20.3-19.4,45.9h0c0,0.1,0,0.1,0,0.2c0,15.6,11.8,28.3,26.3,28.3c14.5,0,26.3-12.7,26.3-28.3c0-0.1,0-0.1,0-0.2h0c0-7.2-2.7-14.1-5.5-19.3c-0.5-1-2.1-0.6-1.9,0.3C174.9,158.1,162.5,171.8,162.5,154.8z"/><g><path class="st1" d="M131.2,215.6c-0.7,0-1.3-0.3-1.8-0.7l-67.2-67.1c-1-1-1-2.6,0-3.6l70.9-70.9c0.5-0.5,1.1-0.7,1.8-0.7h20.4c1.2,0,2,0.8,2.3,1.6c0.3,0.7,0.3,1.9-0.5,2.7l-66.7,66.7c-1.3,1.3-1.3,3.5,0,4.9l52.7,52.7c1,1,1,2.6,0,3.6L133,214.9C132.5,215.4,131.9,215.6,131.2,215.6z"/></g><g><path class="st1" d="M144.7,227.4c-1.2,0-2-0.8-2.3-1.5c-0.3-0.7-0.3-1.9,0.5-2.7l66.7-66.7c0.7-0.6,1-1.5,1-2.4s-0.4-1.8-1-2.4l-52.7-52.7c-1-1-1-2.6,0-3.6l10.2-10.2c0.5-0.5,1.1-0.7,1.8-0.7c0.7,0,1.3,0.3,1.8,0.7l67,67.1c0.5,0.5,0.7,1.1,0.7,1.8s-0.3,1.3-0.7,1.8l-70.9,70.9c-0.5,0.5-1.1,0.7-1.8,0.7H144.7z"/></g></g></svg>
    ...
    <div class="title "> 
        ...
        <h1  itemprop="name"><a href="/projects/listproc/" itemprop="url">ListProc Open Source
            </a>
        </h1>
            ...
            <div class="as-h3 brought-by">
                ...
                Brought to you by:
                    ...
                    <a href="/u/cren/profile/">cren</a>,
                    
                
                    <a href="/u/hundo/profile/">hundo</a>,
                    
                
                    <a href="/u/ppporch/profile/">ppporch</a>
    ...
    <div id="download-group">
        <h4>Get an email when there's a new version of ListProc Open Source</h4>
        <div id="get-updates-form">
            <form>
                <input type="email" name="email" placeholder="Enter your email address" value="ppporch@theporch.com">
                <a id="get-updates-button" class="button blue" data-open="psp-newsletter-modal">Next</a>
            </form>
        </div>
    </div>
    </div>
    <div class="psp_newsletter_subscribe reveal" data-reveal id="psp-newsletter-modal" data-v-offset="0" data-ajax-url="/projects/listproc/get_updates?source=DLP">
...
<div class="social-sharing-buttons invisible hide">
    ...
    <a rel=nofollow class="social-media-icon twitter" href="https://x.com/share?url=https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/append_with_catmail.pl/download&amp;text=Download%20ListProc%20Open%20Source%20on%20SourceForge%20for%20free%21%20" title="Share ListProc Open Source on SourceForge on X">
...
<svg  data-name="x-logo" viewBox="0 0 1200 1227" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" fill="white"/></svg></a>
    <a rel=nofollow class="social-media-icon facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/append_with_catmail.pl/download&title=ListProc%20Open%20Source%20on%20SourceForge" title="Share ListProc Open Source on SourceForge on facebook">
...
<svg  data-name="facebook" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1343 12v264h-157q-86 0-116 36t-30 108v189h293l-39 296h-254v759h-306v-759h-255v-296h255v-218q0-186 104-288.5t277-102.5q147 0 228 12z"/></svg></a>
    <a rel=nofollow class="social-media-icon linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url=https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/append_with_catmail.pl/download&title=ListProc%20Open%20Source%20on%20SourceForge&source=SourceForge.net" title="Share ListProc Open Source on SourceForge on LinkedIn">
...
<svg  data-name="linkedin" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M477 625v991h-330v-991h330zm21-306q1 73-50.5 122t-135.5 49h-2q-82 0-132-49t-50-122q0-74 51.5-122.5t134.5-48.5 133 48.5 51 122.5zm1166 729v568h-329v-530q0-105-40.5-164.5t-126.5-59.5q-63 0-105.5 34.5t-63.5 85.5q-11 30-11 81v553h-329q2-399 2-647t-1-296l-1-48h329v144h-2q20-32 41-56t56.5-52 87-43.5 114.5-15.5q171 0 275 113.5t104 332.5z"/></svg></a>
    ...
    <a class="button default mirror" id="btn-problems-downloading" data-release-url="https://downloads.sourceforge.net/project/listproc/scripts/scripts-092203/append_with_catmail.pl?ts=gAAAAABp9VM8F9UNONiumWRRytj8795cuEpn4wdtYRK6nqQJfCJ0lwTjGTM7fpOvcW5XW68V1kLE-EFnilnORiUE5y4KDggXaQ%3D%3D&amp;use_mirror=master&amp;r=" rel="nofollow" href="/settings/mirror_choices?projectname=listproc&amp;filename=scripts/scripts-092203/append_with_catmail.pl&amp;selected=master">Problems Downloading?</a>
    ...
    <article class="main-content">
        ...
        <div class="small-12 columns hr-bottom">
            <aside class="content-supplement">
                <div class="as-header">
                    <h3>ListProc Open Source Overview</h3>
                </div>

                <div class="project-container">
                    
                    <p id="description">ListProc is a UNIX based automated information distribution and retrieval system for electronic mailing lists and file archives. ListProc is intended to be easy to maintain, support and use.</p>
                </div>
            </aside>
        </div>
...
<section id="project-additional-trove" class="content-supplement">
    <div class="as-header">
        <h2>Additional Details for ListProc Open Source</h2>
    </div>
    <div class="project-container">
    ...
    <section class="content">End Users/Desktop, System Administrators</section>
</section>
        ...
        <section class="project-info">
            ...
            <section class="content">
                <time itemprop="dateModified" class="dateUpdated" datetime="2013-03-22">2013-03-22</time>
            </section>
        </section>
        ...
        <section class="project-info">
            <div class="as-header">
                <h3>Categories</h3>
            </div><a href="/directory/mailing-list-servers/" itemprop="applicationCategory">Mailing List Servers</a></section>
        
        
        <section class="project-info">
            <div class="as-header">
            <h3>Maintainers</h3>
            </div><a href="https://sourceforge.net/u/cren/"><span>cren</span></a>, <a href="https://sourceforge.net/u/hundo/"><span>hundo</span></a>, <a href="https://sourceforge.net/u/ppporch/"><span>ppporch</span></a>
        </section>
...
<svg  data-name="default-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><rect class="st0" width="300" height="300"/><g><path class="st1" d="M162.5,154.8c0-28.9-10.2-42-15.6-46.9c-1.1-1-2.7-0.1-2.6,1.3c1.1,16.3-19.4,20.3-19.4,45.9h0c0,0.1,0,0.1,0,0.2c0,15.6,11.8,28.3,26.3,28.3c14.5,0,26.3-12.7,26.3-28.3c0-0.1,0-0.1,0-0.2h0c0-7.2-2.7-14.1-5.5-19.3c-0.5-1-2.1-0.6-1.9,0.3C174.9,158.1,162.5,171.8,162.5,154.8z"/><g><path class="st1" d="M131.2,215.6c-0.7,0-1.3-0.3-1.8-0.7l-67.2-67.1c-1-1-1-2.6,0-3.6l70.9-70.9c0.5-0.5,1.1-0.7,1.8-0.7h20.4c1.2,0,2,0.8,2.3,1.6c0.3,0.7,0.3,1.9-0.5,2.7l-66.7,66.7c-1.3,1.3-1.3,3.5,0,4.9l52.7,52.7c1,1,1,2.6,0,3.6L133,214.9C132.5,215.4,131.9,215.6,131.2,215.6z"/></g><g><path class="st1" d="M144.7,227.4c-1.2,0-2-0.8-2.3-1.5c-0.3-0.7-0.3-1.9,0.5-2.7l66.7-66.7c0.7-0.6,1-1.5,1-2.4s-0.4-1.8-1-2.4l-52.7-52.7c-1-1-1-2.6,0-3.6l10.2-10.2c0.5-0.5,1.1-0.7,1.8-0.7c0.7,0,1.3,0.3,1.8,0.7l67,67.1c0.5,0.5,0.7,1.1,0.7,1.8s-0.3,1.3-0.7,1.8l-70.9,70.9c-0.5,0.5-1.1,0.7-1.8,0.7H144.7z"/></g></g></svg>
    ...
    <div class="project-info ">
        <div class="result-heading-texts">
            <a href="/projects/lurker/" title="Find out more about Lurker">
                
                <strong>Lurker</strong>
            </a>
            
                <a href="/projects/lurker/" title="Find out more about Lurker" class="summary-inline">Lurker is a mailing list archiver designed for capacity, speed, simplicity, and configurability in that order.
Noteworthy features include: google-style searching on all fields, chronology preserving threads, multilingual, and attachment support.
    ...
    <strong class="">
        <b class="label">Last Update:</b>
            ...
            <time class="dateUpdated" datetime="2013-06-04">2013-06-04</time>
    ...
    <div>
        <a href="/projects/lurker/" title="Find out more about Lurker" class="button green hollow see-project">See Project</a>
    </div>
</li>
...
<svg  data-name="default-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><rect class="st0" width="300" height="300"/><g><path class="st1" d="M162.5,154.8c0-28.9-10.2-42-15.6-46.9c-1.1-1-2.7-0.1-2.6,1.3c1.1,16.3-19.4,20.3-19.4,45.9h0c0,0.1,0,0.1,0,0.2c0,15.6,11.8,28.3,26.3,28.3c14.5,0,26.3-12.7,26.3-28.3c0-0.1,0-0.1,0-0.2h0c0-7.2-2.7-14.1-5.5-19.3c-0.5-1-2.1-0.6-1.9,0.3C174.9,158.1,162.5,171.8,162.5,154.8z"/><g><path class="st1" d="M131.2,215.6c-0.7,0-1.3-0.3-1.8-0.7l-67.2-67.1c-1-1-1-2.6,0-3.6l70.9-70.9c0.5-0.5,1.1-0.7,1.8-0.7h20.4c1.2,0,2,0.8,2.3,1.6c0.3,0.7,0.3,1.9-0.5,2.7l-66.7,66.7c-1.3,1.3-1.3,3.5,0,4.9l52.7,52.7c1,1,1,2.6,0,3.6L133,214.9C132.5,215.4,131.9,215.6,131.2,215.6z"/></g><g><path class="st1" d="M144.7,227.4c-1.2,0-2-0.8-2.3-1.5c-0.3-0.7-0.3-1.9,0.5-2.7l66.7-66.7c0.7-0.6,1-1.5,1-2.4s-0.4-1.8-1-2.4l-52.7-52.7c-1-1-1-2.6,0-3.6l10.2-10.2c0.5-0.5,1.1-0.7,1.8-0.7c0.7,0,1.3,0.3,1.8,0.7l67,67.1c0.5,0.5,0.7,1.1,0.7,1.8s-0.3,1.3-0.7,1.8l-70.9,70.9c-0.5,0.5-1.1,0.7-1.8,0.7H144.7z"/></g></g></svg>
    ...
    <div class="project-info ">
        <div class="result-heading-texts">
            <a href="/projects/ezmlm-www/" title="Find out more about ezmlm-www">
                
                <strong>ezmlm-www</strong>
            </a>
            
                <a href="/projects/ezmlm-www/" title="Find out more about ezmlm-www" class="summary-inline">Provides a simple Perl/CGI interface to browse ezmlm-idx archives.</a>
    ...
    <strong class="">
        <b class="label">Last Update:</b>
            ...
            <time class="dateUpdated" datetime="2013-04-17">2013-04-17</time>
    ...
    <div>
        <a href="/projects/ezmlm-www/" title="Find out more about ezmlm-www" class="button green hollow see-project">See Project</a>
    </div>
</li>
...
<div class="project-icon   " >
    ...
    <img alt="Dada Mail" title="Dada Mail" 
src="//a.fsdn.com/allura/p/dadamail/icon?1486155577"
     loading="lazy"/></div>

    
    <div class="project-info ">
        <div class="result-heading-texts">
            <a href="/projects/dadamail/" title="Find out more about Dada Mail">
                
                <strong>Dada Mail</strong>
            </a>
            
                <a href="/projects/dadamail/" title="Find out more about Dada Mail" class="summary-inline">Dada Mail is a Contemporary Mailing List Manager, enabling you to easily run a verified mailing list that your subscribers can trust, right on your own website.
...
<svg  data-name="sf_star_yellow" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 285.8" style="enable-background:new 0 0 300 285.8;" xml:space="preserve"><polygon class="st0" fill="#ffcc00" points="150,0 185.4,109.2 300,109.2 207.3,176.6 242.7,285.8 150,218.3 57.3,285.8 92.7,176.6 0,109.2 114.6,109.2 "/></svg>
        ...
        <a href="/projects/dadamail/reviews/" class="count" title="Dada Mail Reviews">
            1 Review
        </a>
    </div>
    ...
    <strong class="">
        <b class="label">Last Update:</b>
            ...
            <time class="dateUpdated" datetime="2023-09-16">2023-09-16</time>
    ...
    <div>
        <a href="/projects/dadamail/" title="Find out more about Dada Mail" class="button green hollow see-project">See Project</a>
    </div>
</li>
...
<svg  data-name="default-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><rect class="st0" width="300" height="300"/><g><path class="st1" d="M162.5,154.8c0-28.9-10.2-42-15.6-46.9c-1.1-1-2.7-0.1-2.6,1.3c1.1,16.3-19.4,20.3-19.4,45.9h0c0,0.1,0,0.1,0,0.2c0,15.6,11.8,28.3,26.3,28.3c14.5,0,26.3-12.7,26.3-28.3c0-0.1,0-0.1,0-0.2h0c0-7.2-2.7-14.1-5.5-19.3c-0.5-1-2.1-0.6-1.9,0.3C174.9,158.1,162.5,171.8,162.5,154.8z"/><g><path class="st1" d="M131.2,215.6c-0.7,0-1.3-0.3-1.8-0.7l-67.2-67.1c-1-1-1-2.6,0-3.6l70.9-70.9c0.5-0.5,1.1-0.7,1.8-0.7h20.4c1.2,0,2,0.8,2.3,1.6c0.3,0.7,0.3,1.9-0.5,2.7l-66.7,66.7c-1.3,1.3-1.3,3.5,0,4.9l52.7,52.7c1,1,1,2.6,0,3.6L133,214.9C132.5,215.4,131.9,215.6,131.2,215.6z"/></g><g><path class="st1" d="M144.7,227.4c-1.2,0-2-0.8-2.3-1.5c-0.3-0.7-0.3-1.9,0.5-2.7l66.7-66.7c0.7-0.6,1-1.5,1-2.4s-0.4-1.8-1-2.4l-52.7-52.7c-1-1-1-2.6,0-3.6l10.2-10.2c0.5-0.5,1.1-0.7,1.8-0.7c0.7,0,1.3,0.3,1.8,0.7l67,67.1c0.5,0.5,0.7,1.1,0.7,1.8s-0.3,1.3-0.7,1.8l-70.9,70.9c-0.5,0.5-1.1,0.7-1.8,0.7H144.7z"/></g></g></svg>
    ...
    <div class="project-info ">
        <div class="result-heading-texts">
            <a href="/projects/cure/" title="Find out more about CURE">
                
                <strong>CURE</strong>
            </a>
            
                <a href="/projects/cure/" title="Find out more about CURE" class="summary-inline">CURE provides a web-based environment for distributed collaboration. It was designed for lerning groups but is now also used to support busines collaboration. It combines wiki ideas with mailing lists, shared folders, chats, and room metaphors.</a>
    ...
    <strong class="">
        <b class="label">Last Update:</b>
            ...
            <time class="dateUpdated" datetime="2013-04-22">2013-04-22</time>
    ...
    <div>
        <a href="/projects/cure/" title="Find out more about CURE" class="button green hollow see-project">See Project</a>
    </div>
</li>
...
<svg  data-name="default-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><rect class="st0" width="300" height="300"/><g><path class="st1" d="M162.5,154.8c0-28.9-10.2-42-15.6-46.9c-1.1-1-2.7-0.1-2.6,1.3c1.1,16.3-19.4,20.3-19.4,45.9h0c0,0.1,0,0.1,0,0.2c0,15.6,11.8,28.3,26.3,28.3c14.5,0,26.3-12.7,26.3-28.3c0-0.1,0-0.1,0-0.2h0c0-7.2-2.7-14.1-5.5-19.3c-0.5-1-2.1-0.6-1.9,0.3C174.9,158.1,162.5,171.8,162.5,154.8z"/><g><path class="st1" d="M131.2,215.6c-0.7,0-1.3-0.3-1.8-0.7l-67.2-67.1c-1-1-1-2.6,0-3.6l70.9-70.9c0.5-0.5,1.1-0.7,1.8-0.7h20.4c1.2,0,2,0.8,2.3,1.6c0.3,0.7,0.3,1.9-0.5,2.7l-66.7,66.7c-1.3,1.3-1.3,3.5,0,4.9l52.7,52.7c1,1,1,2.6,0,3.6L133,214.9C132.5,215.4,131.9,215.6,131.2,215.6z"/></g><g><path class="st1" d="M144.7,227.4c-1.2,0-2-0.8-2.3-1.5c-0.3-0.7-0.3-1.9,0.5-2.7l66.7-66.7c0.7-0.6,1-1.5,1-2.4s-0.4-1.8-1-2.4l-52.7-52.7c-1-1-1-2.6,0-3.6l10.2-10.2c0.5-0.5,1.1-0.7,1.8-0.7c0.7,0,1.3,0.3,1.8,0.7l67,67.1c0.5,0.5,0.7,1.1,0.7,1.8s-0.3,1.3-0.7,1.8l-70.9,70.9c-0.5,0.5-1.1,0.7-1.8,0.7H144.7z"/></g></g></svg>
    ...
    <div class="project-info ">
        <div class="result-heading-texts">
            <a href="/projects/pommo/" title="Find out more about poMMo - The post modern Mass Mailer">
                
                <strong>poMMo - The post modern Mass Mailer</strong>
            </a>
            
                <a href="/projects/pommo/" title="Find out more about poMMo - The post modern Mass Mailer" class="summary-inline">poMMo is versatile Mass Mailing software. Add a mailing list to your website, or organize stand alone mailings. Unique features such as the ability to mail subsets of your subscribers set it apart from alternatives.</a>
...
<svg  data-name="sf_star_yellow_half" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><path class="st1" fill="#CCCCCB" d="M148.8,223.4c-31.1,22.9-62.2,45.8-93.5,68.9c0.1-0.4,0.2-0.7,0.3-0.9c12.7-35.9,25.3-71.7,38-107.6c0.2-0.6,0.2-1-0.4-1.4c-30.8-21.4-61.6-42.8-92.4-64.2c-0.7-0.5-0.9-1-0.7-1.8c0.4,0,0.8,0,1.1,0c26.2,0.3,52.4,0.7,78.6,1c11.3,0.2,22.7,0.3,34,0.5c0.8,0,1.1-0.2,1.4-1c11.1-36.2,22.3-72.4,33.4-108.5c0.1-0.2,0.1-0.4,0.3-0.8c11.3,37.1,22.6,74,34,110.9c39-0.8,78-1.5,117.2-2.3c-0.3,0.3-0.5,0.4-0.7,0.6c-15.7,11-31.5,22.1-47.2,33.1c-15.5,10.8-30.9,21.7-46.4,32.5c-0.5,0.4-0.6,0.7-0.4,1.3c12.1,35.8,24.3,71.6,36.4,107.4c0.1,0.2,0.1,0.4,0.2,0.8C210.8,269.1,179.8,246.3,148.8,223.4z"/><path class="st0" fill="#ffcc00" d="M148.8,223.4c-31.1,22.9-62.2,45.8-93.5,68.9c0.1-0.4,0.2-0.7,0.3-0.9c12.7-35.9,25.3-71.7,38-107.6c0.2-0.6,0.2-1-0.4-1.4c-30.8-21.4-61.6-42.8-92.4-64.2c-0.7-0.5-0.9-1-0.7-1.8c0.4,0,0.8,0,1.1,0c26.2,0.3,52.4,0.7,78.6,1c11.3,0.2,22.7,0.3,34,0.5c0.8,0,1.1-0.2,1.4-1c11.1-36.2,22.3-72.4,33.4-108.5c0.1-0.2,0.1-0.4,0.3-0.8"/></svg>
        ...
        <a href="/projects/pommo/reviews/" class="count" title="poMMo - The post modern Mass Mailer Reviews">
            13 Reviews
        </a>
    </div>
    ...
    <strong class="">
        <b class="label">Last Update:</b>
            ...
            <time class="dateUpdated" datetime="2013-04-25">2013-04-25</time>
    ...
    <div>
        <a href="/projects/pommo/" title="Find out more about poMMo - The post modern Mass Mailer" class="button green hollow see-project">See Project</a>
    </div>
</li>
...
<aside class="m-wide-widget m-wide-projects-widget ">
    <div class="as-header">
        ...
        Top 3 Projects in Mailing List Servers
    </div>
    <div class="body">
        <ul>
...
<div class="project-icon   " >
    ...
    <img alt="phpList" title="phpList" 
src="//a.fsdn.com/allura/p/phplist/icon?1696515957?&amp;w=48"
    srcset="//a.fsdn.com/allura/p/phplist/icon?1696515957?&amp;w=72 1.5x
        ,
            //a.fsdn.com/allura/p/phplist/icon?1696515957?&amp;w=96 2x" loading="lazy"/></div>

    
    <div class="project-info ">
        <div class="result-heading-texts">
            <a href="/projects/phplist/" title="Find out more about phpList">
                
                <strong>phpList</strong>
            </a>
            
                <a href="/projects/phplist/" title="Find out more about phpList" class="summary-inline">phpList delivers Open Source email marketing, including analytics, list segmentation, content personalisaton and bounce processing. Extensive technical features and a secure and stable codebase are the result of over 17 years of continuous development.

Used in 95 countries, available in 20+ languages, and used to send 25 billion email campaigns last year.

Deploy it with your own SMTP server, or get a free hosted account at http://phplist.com.</a>
...
<svg  data-name="sf_star_yellow_half" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><path class="st1" fill="#CCCCCB" d="M148.8,223.4c-31.1,22.9-62.2,45.8-93.5,68.9c0.1-0.4,0.2-0.7,0.3-0.9c12.7-35.9,25.3-71.7,38-107.6c0.2-0.6,0.2-1-0.4-1.4c-30.8-21.4-61.6-42.8-92.4-64.2c-0.7-0.5-0.9-1-0.7-1.8c0.4,0,0.8,0,1.1,0c26.2,0.3,52.4,0.7,78.6,1c11.3,0.2,22.7,0.3,34,0.5c0.8,0,1.1-0.2,1.4-1c11.1-36.2,22.3-72.4,33.4-108.5c0.1-0.2,0.1-0.4,0.3-0.8c11.3,37.1,22.6,74,34,110.9c39-0.8,78-1.5,117.2-2.3c-0.3,0.3-0.5,0.4-0.7,0.6c-15.7,11-31.5,22.1-47.2,33.1c-15.5,10.8-30.9,21.7-46.4,32.5c-0.5,0.4-0.6,0.7-0.4,1.3c12.1,35.8,24.3,71.6,36.4,107.4c0.1,0.2,0.1,0.4,0.2,0.8C210.8,269.1,179.8,246.3,148.8,223.4z"/><path class="st0" fill="#ffcc00" d="M148.8,223.4c-31.1,22.9-62.2,45.8-93.5,68.9c0.1-0.4,0.2-0.7,0.3-0.9c12.7-35.9,25.3-71.7,38-107.6c0.2-0.6,0.2-1-0.4-1.4c-30.8-21.4-61.6-42.8-92.4-64.2c-0.7-0.5-0.9-1-0.7-1.8c0.4,0,0.8,0,1.1,0c26.2,0.3,52.4,0.7,78.6,1c11.3,0.2,22.7,0.3,34,0.5c0.8,0,1.1-0.2,1.4-1c11.1-36.2,22.3-72.4,33.4-108.5c0.1-0.2,0.1-0.4,0.3-0.8"/></svg>
        ...
        <a href="/projects/phplist/reviews/" class="count" title="phpList Reviews">
            33 Reviews
        </a>
    </div>
    ...
    <strong class="">
        <b class="label">Last Update:</b>
            ...
            <time class="dateUpdated" datetime="2025-06-21">2025-06-21</time>
    ...
    <div>
        <a href="/projects/phplist/" title="Find out more about phpList" class="button green hollow see-project">See Project</a>
    </div>
</li>
...
<svg  data-name="default-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><rect class="st0" width="300" height="300"/><g><path class="st1" d="M162.5,154.8c0-28.9-10.2-42-15.6-46.9c-1.1-1-2.7-0.1-2.6,1.3c1.1,16.3-19.4,20.3-19.4,45.9h0c0,0.1,0,0.1,0,0.2c0,15.6,11.8,28.3,26.3,28.3c14.5,0,26.3-12.7,26.3-28.3c0-0.1,0-0.1,0-0.2h0c0-7.2-2.7-14.1-5.5-19.3c-0.5-1-2.1-0.6-1.9,0.3C174.9,158.1,162.5,171.8,162.5,154.8z"/><g><path class="st1" d="M131.2,215.6c-0.7,0-1.3-0.3-1.8-0.7l-67.2-67.1c-1-1-1-2.6,0-3.6l70.9-70.9c0.5-0.5,1.1-0.7,1.8-0.7h20.4c1.2,0,2,0.8,2.3,1.6c0.3,0.7,0.3,1.9-0.5,2.7l-66.7,66.7c-1.3,1.3-1.3,3.5,0,4.9l52.7,52.7c1,1,1,2.6,0,3.6L133,214.9C132.5,215.4,131.9,215.6,131.2,215.6z"/></g><g><path class="st1" d="M144.7,227.4c-1.2,0-2-0.8-2.3-1.5c-0.3-0.7-0.3-1.9,0.5-2.7l66.7-66.7c0.7-0.6,1-1.5,1-2.4s-0.4-1.8-1-2.4l-52.7-52.7c-1-1-1-2.6,0-3.6l10.2-10.2c0.5-0.5,1.1-0.7,1.8-0.7c0.7,0,1.3,0.3,1.8,0.7l67,67.1c0.5,0.5,0.7,1.1,0.7,1.8s-0.3,1.3-0.7,1.8l-70.9,70.9c-0.5,0.5-1.1,0.7-1.8,0.7H144.7z"/></g></g></svg>
    ...
    <div class="project-info ">
        <div class="result-heading-texts">
            <a href="/projects/hmailserver/" title="Find out more about hMailServer">
                
                <strong>hMailServer</strong>
            </a>
            
                <a href="/projects/hmailserver/" title="Find out more about hMailServer" class="summary-inline">hMailServer is a SMTP/POP3/IMAP server for Windows. Data is stored in MySQL/MSSQL database and is easily accessed using the COM library. Project info, trackers and downloads has moved to www.hmailserver.com. </a>
...
<svg  data-name="sf_star_yellow" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 300 285.8" style="enable-background:new 0 0 300 285.8;" xml:space="preserve"><polygon class="st0" fill="#ffcc00" points="150,0 185.4,109.2 300,109.2 207.3,176.6 242.7,285.8 150,218.3 57.3,285.8 92.7,176.6 0,109.2 114.6,109.2 "/></svg>
        ...
        <a href="/projects/hmailserver/reviews/" class="count" title="hMailServer Reviews">
            1 Review
        </a>
    </div>
    ...
    <strong class="">
        <b class="label">Last Update:</b>
            ...
            <time class="dateUpdated" datetime="2015-08-24">2015-08-24</time>
    ...
    <div>
        <a href="/projects/hmailserver/" title="Find out more about hMailServer" class="button green hollow see-project">See Project</a>
    </div>
</li>
    ...
    <div class="small-12 column">
        <div class="row is-collapse-child">
            <div class="small-12 column">
                ...
                <div class="subscribe-tagline">Get notified by email when ListProc Open Source releases a new version.</div>
...
<form action="/user/newsletters/subscribe" method="post"
      ...
      data-shortname="listproc" data-handler="KMUNSWidget">
    <input type="hidden" name="country_code_source" value="user">
    <input type="hidden" name="source" value="DLP">

    <div class="row">
        <div class="column small-12 large-6">
            <input type="email" class="subscriber-email" name="email"  placeholder="Enter your email address" value="ppporch@theporch.com" required autocapitalize="none">
...
<select id="employees-7368098" name="employees"  class="employees use-placeholder-color" >
...
<label class="input-set input-set-kmu kmunl_consent allow-precheck ">
    <span class="checkbox"> <input type="checkbox" name="kmu" value="listproc"   data-consent-action data-consent-id=67c8e2504e339052243db488 ></span>
...
<label class="input-set input-set-agree-general-gdpr minimum-explicit-required column small-12">
    ...
    <input type="hidden" name="_visit_cookie" value="0a2bf8b6-cbdf-461b-b278-ab357924498f"/>
</form>
...
<div class="scroll-fixable">
        ...
        <aside class="m-sidebar-widget">
            ...
            <div class="body">
                <ul><li class="item"><a href="/software/smtp/">SMTP</a></li></ul>
            </div>
        </aside>
...
<span></span>
    ...
    <script>
        ...
        $.extend(SF, {"shortname":"listproc","noCountDown":false,"downloadDelay":5000});
        ...
        function loadimg(params, dimension_prefix) {
            params = Object.assign({"idsite":1,"rec":1,"rand":43199,"dimension2":"pg_dwnld","url":"https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/append_with_catmail.pl/download","action_name":"Download append_with_catmail.pl (ListProc Open Source)"}, params);
    ...
    SF.verbose = SF.verbose || {};
        ...
        <script src="//a.fsdn.com/con/js/min/sf.sandiego-dwnld.js?1777491863"></script>
...
<script>
    (function () {
        function load_bombora() {
            ...
            _ml.eid = '771';
            _ml.fp = '0a2bf8b6-cbdf-461b-b278-ab357924498f';  
...
<script type="text/javascript">
    bizx.cmp.ifConsent({ purposes: ['storage', 'measurement'], vendors: 'google-analytics'}, function () {
        ...
        gtag('js', new Date());
        gtag('set', {
            'page_location': 'https://sourceforge.net/projects/listproc/files/scripts/scripts-092203/append_with_catmail.pl/download',
        });
    });
</script>
    <script>
        ...
        SF.devicePixelRatio = Math.round(window.getDevicePixelRatio()*10)/10;
            ...
            bizx.cmp.ifConsent({ purposes: ['storage', 'measurement'], vendors: 'google-analytics'}, function () {
                gtag('config', 'G-1H226E4E4L', {
                    ...
                    'SF_Project_Shortname': 'listproc', 
                    'SF_Page_Type': 'pg_dwnld', 
                    user_properties: {
                        'SF_Logged_in': 'Dev-this-project', 
                    },
                    'SF_Ads_Disabled': 'Yes',   
    ...
    $(function() {
        bizx.cmp.ifConsent({ purposes: 'all' , vendors: 'narrative'}, function() {
            ...
            let imageUrl = "https://io.narrative.io/?companyId=2440&id=first_party%3A0a2bf8b6-cbdf-461b-b278-ab357924498f&id=site_name%3Asourceforge.net&id=url%3A%2Fprojects%2Flistproc%2Ffiles%2Fscripts%2Fscripts-092203%2Fappend_with_catmail.pl%2Fdownload&id=pagetitle%3ADownload+append_with_catmail.pl+%28ListProc+Open+Source%29&id=vertical%3AOpen+Source+Software&id=product%3AListProc+Open+Source&id=topics%3AMailing+List+Servers&id=action%3ADownloaded+ListProc+Open+Source&id=action%3ADownloaded+Mailing+List+Servers+Software";
...
<script>
        ...
        <span id="22cc6527-d503-48a0-b812-59368e68434b"></span>
        <script>
            bizx.cmp.trackingPixel('', ['storage', 'measurement', 'ads'], 'https://passport.bizx.info/opi/v1/contacts/put-fpe/dbb1d8999b1b50639defedfb75d98a10?action=https%3A//sourceforge.net/projects/listproc/files/scripts/scripts-092203/append_with_catmail.pl/download&amp;source=webpage&amp;topics=Mailing%20List%20Servers', '', '22cc6527-d503-48a0-b812-59368e68434b', true);
        </script>
