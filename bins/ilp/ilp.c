...
SCCS file: /usr/SCCS/home/server/listproc/src/s.ilp.c
*/
#ifdef SCCS
...
/*
  ...
  This program is to be used for connecting to an interactive ListProcessor
  ...
  SCO systems should compile with -Dsco
...
int main (int argc, char **argv)
{
  ...
  printf ("%s not functional. Try compiling archives/ilp/ilp.c\n", argv[0]);
#else
  char *options = "vt:b:V";
...
{
  long int bytes_written = 0, total_bytes = 0;
